  ...
  return (
    <Page ref={ref} isLeft={isLeft}>
      <div className="h-full flex flex-col items-center justify-center">
        ...
        <h2 className="font-heading text-2xl md:text-3xl font-bold text-center leading-tight text-foreground">
...
const RealisticPageFlip = forwardRef(({ 
  ...
  return (
    <div className={`realistic-page-flip relative ${className}`} style={{ 
      // Force dimensions to ensure book displays at proper size
      width: isMobilePortrait ? `${width}px` : `${width * 2 + 40}px`,
      height: `${height + 60}px`,
      minWidth: isMobilePortrait ? `${width}px` : `${width * 2}px`,
      minHeight: `${height}px`,
      display: 'flex',
      alignItems: 'center',
