...
const GENRE_SECTIONS = [
  ...
  { name: 'Fantasy', position: { x: -1.01, z: -8.12 }, bannerPos: { x: -1.01, y: 5.7, z: -7.5 }, rotation: 0, color: '#ec4899', calibrated: true },
  
  // CALIBRATED - Comic at X:-3.41, Y:5.70, Z:-6.38 - moved toward Fantasy
  { name: 'Comic', position: { x: -3.41, z: -6.38 }, bannerPos: { x: -2.5, y: 5.7, z: -6.5 }, rotation: 0, color: '#f97316', calibrated: true },
