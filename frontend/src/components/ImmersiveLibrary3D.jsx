...
const GENRE_SECTIONS = [
  ...
  { name: 'Fantasy', position: { x: -1.01, z: -8.12 }, bannerPos: { x: -1.01, y: 6.0, z: -7.5 }, rotation: 0, color: '#ec4899', calibrated: true },
  
  // CALIBRATED - Science Fiction at X:-3.21, Y:5.90, Z:-5.76
  { name: 'Science Fiction', position: { x: -3.21, z: -5.76 }, bannerPos: { x: -3.21, y: 6.0, z: -5.76 }, rotation: 0, color: '#06b6d4', calibrated: true },
