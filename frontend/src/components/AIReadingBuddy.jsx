  ...
  if (!isOpen) {
    ...
    return (
      <motion.button
        ...
        whileTap={{ scale: 0.9 }}
        onClick={onToggle}
        className="fixed bottom-6 left-4 z-[110] w-14 h-14 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full shadow-lg flex items-center justify-center text-white"
