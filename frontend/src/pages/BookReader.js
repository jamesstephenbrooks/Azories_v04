...
export default function BookReader() {
  ...
  const goToPage = useCallback((newPage, direction, jumpDirect = false) => {
    ...
    // For mobile portrait/landscape, navigate through the flipbook ref (same as desktop)
    // This triggers the actual page-curl animation from react-pageflip
  ...
  }, [allPages, isFlipping, audioElement, saveReadingProgress]);
