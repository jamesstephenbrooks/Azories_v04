...
export default function BookReader() {
  ...
  return (
    <div className={`min-h-screen ${theme === 'dark' ? 'bg-[#1a1a2e]' : 'bg-[#f8f5f0]'}`}>
      ...
      <div 
        id="book-container"
        className={`${isMobileLandscape ? 'pt-10 pb-16' : 'pt-12 sm:pt-20 pb-24 sm:pb-48'} px-1 sm:px-4 flex items-center justify-center min-h-screen transition-all duration-300 ${
