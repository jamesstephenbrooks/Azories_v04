              ...
              <div className="relative w-full h-screen">
                ...
                {currentPageData?.isBackCover ? (
                  ...
                  >
                    ...
                    <div 
                      className="flex-1 bg-[#fdfbf7] rounded-r-lg overflow-hidden flex flex-col relative"
                      style={{ 
                    ...
                    >
                      ...
                      >
                        {(currentPageData?.text_content || currentPageData?.text || currentPageData?.content) ? (
                          <p className="font-reader text-sm leading-relaxed text-gray-800 whitespace-pre-wrap text-center">
                            {currentPageData.text_content || currentPageData.text || currentPageData.content}
                          </p>
                        ) : currentPageData?.isChapterTitle ? (
                          <div className="text-center">
                      ...
                      {showScrollIndicator && (
                        <div className="absolute bottom-12 left-0 right-0 pointer-events-none">
                          <div className="h-8 bg-gradient-to-t from-[#fdfbf7] to-transparent" />
