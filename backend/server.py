...
async def forgot_password(request: ForgotPasswordRequest, background_tasks: BackgroundTasks):
    ...
    app_url = os.environ.get("APP_URL", "https://azories-pro-studio.preview.emergentagent.com")
...
async def generate_invite_link(book_id: str, request: InviteLinkRequest, current_user: dict = Depends(get_current_user)):
    ...
    base_url = os.environ.get('FRONTEND_URL', 'https://azories-pro-studio.preview.emergentagent.com')
...
async def submit_contact_form(
    ...
    <body style="font-family: Arial, sans-serif; padding: 20px; max-width: 600px; margin: 0 auto;">
        ...
        <div style="background: #ffffff; padding: 20px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 12px 12px;">
            <table style="width: 100%; border-collapse: collapse; margin: 15px 0;">
                <tr>
                    <td style="padding: 10px 0; border-bottom: 1px solid #e5e7eb; width: 100px;"><strong>From:</strong></td>
    ...
    if email_configured():
        background_tasks.add_task(send_email, admin_email, f"[Azories Contact] {subject}", html_content)
        logging.info(f"Contact form email sent to {admin_email} from {email}")
        
        if backup_email and backup_email != admin_email:
            background_tasks.add_task(send_email, backup_email, f"[BACKUP] [Azories Contact] {subject}", html_content)
